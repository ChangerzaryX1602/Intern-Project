...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/attack": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Keyword to filter attacks",
                        "name": "keyword",
                        "in": "query"
                    },
                    {
        ...
        "/api/v1/attack/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated attack data",
                        "name": "attack",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/auth/reset-password/verify": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "VerifyTokenAndResetPasswordRequest",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.VerifyTokenAndResetPasswordRequest"
                        }
                    }
                ],
                "responses": {}
        ...
        "/api/v1/auth/reset-password/{email}/issue-token": {
            "post": {
        ...
        "/api/v1/detect/": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Objects JSON array",
                        "name": "objects",
                        "in": "formData"
                    },
                    {
        ...
        "/api/v1/detect/by-cameras": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Request body with camera IDs",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/mqtt.FilePathRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/mqtt/upload-file": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "File to upload and send (.pt, .pth, etc.)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    },
                    {
                        "type": "boolean",
                        "description": "Encode file as base64 (default: true)",
                        "name": "encode_base64",
                        "in": "formData"
                    }
                ],
    ...
    "definitions": {
        ...
        "models.VerifyTokenAndResetPasswordRequest": {
            "type": "object",
            "properties": {
                "password": {
                    "type": "string"
